(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('jdlDemoApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-jdlDemoApp-error');
                var entityKey = httpResponse.headers('X-jdlDemoApp-params');
                if (errorHeader) {
